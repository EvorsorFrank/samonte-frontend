const TomatoTargetSpotMT = () => {
  return (
    <>
      ...
      <div className='mt-1'>
        Step 2: If you spot a leaf with the signs and symptoms and tomato that look deformed or
      ...
      <div className='mt-1'>
        1. Use tomato varieties that are resistant to fungal and other diseases; this way, you won't worry much
        about the susceptibility to various plant diseases.
      </div>

      <div className='mt-1'>
        2. Outsmart these plant diseases by crop rotation; avoid planting tomato in the exact location yearly.
      ...
      <div className='mt-1'>
        The primary strategy used to manage target spot on tomato is the regular application of fungicides. Applications should begin before symptoms appear when conditions are favorable for infection and disease development. Fungicides may need to be applied at regular intervals (every 10 to 14 days is common) depending on the label directions of the products used. Full coverage of all plant surfaces is needed for the best control of target spot.
      </div>
      ...
      <div className='mt-1 break-all'>
        <b>Source:</b> <a target="_blank" href="https://www.vegetables.bayer.com/ca/en-ca/resources/agronomic-spotlights/target-spot-of-tomato.html">
...
export default TomatoTargetSpotMT